<?php
	...
	$count = mysqli_num_rows($result);
	    ...
	    header('Location:index.php');
	        ...
	        $fmsg = "Username atau password salah.";
	    }
    }
?>
<!DOCTYPE html>
        ...
        <div class="container-fluid header bg-white p-0">
            <div class="row g-0 align-items-center flex-column-reverse flex-md-row">
                <div class="col-md-6 p-5 mt-lg-5">
                    ...
                    <a href="register.php"><p class="animated fadeIn mb-4 pb-2">Belum Punya Akun?</p></a>
                    <a href="index.html" class="btn btn-primary py-3 px-5 me-3 animated fadeIn">Masuk</a>
                </div>
